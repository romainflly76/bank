 ...
 <div id="carouselExampleDark" class="carousel slide carousel-fade"" data-bs-ride=" carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active" data-bs-interval="7000">
                    <img src="img/children-g9a39d50a0_1920.jpg" class="d-block w-100" alt="">
                    ...
                    <div id="visuelHeader" class="carousel-caption"
                        ...
                        <a id="boutonHeader" class="btn btn-lg border-white text-white"
                            style="background-color: #9A616D;" href="#" role="button">En
                            savoir
                            plus</a>
                    </div>
                </div>
                <div class="carousel-item" data-bs-interval="5000">
                    ...
                    <div id="visuelHeader" class="carousel-caption"
                        ...
                        <hr class="my-4">
                        <p>Prenez contact en agence avec l'un de nos conseiller.</p>
                        <a id="boutonHeader" class="btn btn-primary btn-lg border-white" href="#" role="button">En
                            savoir
                            plus</a>
                ...
                <div class="carousel-item">
                    ...
                    <div id="visuelHeader" class="carousel-caption"
                        ...
                        <hr class="my-4">
                        <p>Prenez contact en agence avec l'un de nos conseiller.</p>
                        <a id="boutonHeader" class="btn btn-warning btn-lg border-white" href="#" role="button">En
                            savoir
                            plus</a>
